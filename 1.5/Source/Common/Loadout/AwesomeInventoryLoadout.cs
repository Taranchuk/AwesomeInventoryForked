...
namespace AwesomeInventory.Loadout
{
    ...
    /// </para>
    /// </remarks>
    public class AwesomeInventoryLoadout : ApparelPolicy, IList<ThingGroupSelector>
    {
        /// <summary>
        ...
        public AwesomeInventoryLoadout(AwesomeInventoryLoadout other, bool shallow = false)
        {
            ...
            this.id = Current.Game.outfitDatabase.AllOutfits.Max(o => o.id) + 1;
        ...
        public AwesomeInventoryLoadout(Pawn pawn)
        {
            ...
            if (pawn.outfits?.CurrentApparelPolicy?.filter is ThingFilter filter)
        ...
        public static AwesomeInventoryLoadout MakeEmptyLoadout(Pawn pawn)
        {
            ...
            loadout.id = Current.Game.outfitDatabase.AllOutfits.Max(o => o.id) + 1;
        ...
        /// Save state.
        /// </summary>
#pragma warning disable CS0114 // Member hides inherited member; missing new keyword
        public virtual void ExposeData()
        {
            ...
            {
                this.Costumes = costumes.Where(c => c != null).ToList();
            }
        }
#pragma warning restore CS0114 // Member hides inherited member; missing new keyword
