...
namespace AwesomeInventory.Common.HarmonyPatches
{
    ...
    public static class OutfitDatabase_TryDelete
    {
        ...
        {
            MethodInfo original = AccessTools.Method(typeof(OutfitDatabase), nameof(OutfitDatabase.TryDelete));
        ...
        public static void Postfix(ApparelPolicy apparelPolicy, AcceptanceReport __result)
        {
            ...
            {
                if (apparelPolicy is AwesomeInventoryLoadout loadout)
                {
        ...
        public static bool Prefix(ApparelPolicy outfit, ref AcceptanceReport __result)
        {
            ...
            if (outfit.GetType() == typeof(AwesomeInventoryLoadout))
            {
                ...
                foreach (var costume in (outfit as AwesomeInventoryLoadout).Costumes)
                {
                    ...
                    {
                        if (pawn.outfits?.CurrentApparelPolicy == costume)
                        {
